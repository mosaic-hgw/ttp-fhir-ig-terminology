...
```json
{
  ...
  "status" : "active",
  "date" : "2025-12-17T12:41:46+00:00",
  ...
  "packageId" : "ths-greifswald.ttp-fhir-gw.terminology",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "https://ths-greifswald.de/fhir/terminology/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
